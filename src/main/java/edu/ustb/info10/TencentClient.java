...
public class TencentClient {
	...
	public static void main(String[] args) {
		...
		try {
			...
			/********************* 获取验证码 ***********************/
			HttpGet get = new HttpGet("http://ptlogin2.qq.com/check?uin="
					+ "285699732" + "&appid=46000101&r=0.37908964480776913");
			...
			if (engine instanceof Invocable) {
				...
				pass = (String) invoke.invokeFunction("preprocess", "zhoujie1231",
						checkNum[1]);
			...
			nvps.add(new BasicNameValuePair("wizardurl",
					"http://news.qq.com/a/20120331/000027.htm"));
